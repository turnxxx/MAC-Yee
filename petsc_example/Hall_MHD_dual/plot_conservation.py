...
CONSERVATION_FOLDER='output/conservation/backup'
DPI=600
...
def plot_energy(orderlist, filename, subtract_first=True, type='Total'):
    ...
    for order in orderlist:
        ...
        subfolder = CONSERVATION_FOLDER + "/N8Order" + str(order)
        ...
        if type == 'Total':
            ...
            if subtract_first:
                ...
                label_1 = r'$E_{2,h} - E_{2,h}^1$ ($k = ' + str(order) + '$)'
                label_2 = r'$E_{1,h} - E_{1,h}^1$ ($k = ' + str(order) + '$)'
            ...
            if subtract_first:
                ...
                label_1 = r'$\mathcal{H}_{M,1}-\mathcal{H}_{M,1}^1$ ($k = ' + str(order) + '$)'
                label_2 = r'$\mathcal{H}_{M,2}-\mathcal{H}_{M,2}^1$ ($k = ' + str(order) + '$)'
            else:
                label_1 = r'$\mathcal{H}_{M,1}$ ($k = ' + str(order) + '$)'
                label_2 = r'$\mathcal{H}_{M,2}$ ($k = ' + str(order) + '$)'
...
if __name__ == '__main__':
    ...
    # dirname = "output/conservation/N8Order1"
    
    # plot_energy(dirname)
    # plot_divergence(dirname)
    # plot_helicity(dirname)
    
    
    # dirname = "output/conservation/N8Order2"
    
    # plot_energy(dirname)
    # plot_divergence(dirname)
    # plot_helicity(dirname)
        
    plot_energy(orderlist=[1,2], filename="total_energy", subtract_first=True, type='Total')
    plot_energy(orderlist=[1,2], filename="magnetic_helicity", subtract_first=True, type='magnetic_helicity')
    
    plot_energy(orderlist=[1], filename="kinetic_energy_order_1", subtract_first=False, type='kinetic')
    plot_energy(orderlist=[1], filename="magnetic_energy_order_1", subtract_first=False, type='magnetic')
    
    plot_energy(orderlist=[2], filename="kinetic_energy_order_2", subtract_first=False, type='kinetic')
    plot_energy(orderlist=[2], filename="magnetic_energy_order_2", subtract_first=False, type='magnetic')
    
    plot_energy(orderlist=[1], filename="divergence_error_order_1", subtract_first=False, type='divergence')
    plot_energy(orderlist=[2], filename="divergence_error_order_2", subtract_first=False, type='divergence')
