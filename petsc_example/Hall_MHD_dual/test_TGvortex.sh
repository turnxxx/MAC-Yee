...
# Test case
TESTCASE=14 # Taylor-Green vortex
...
ORDER=1
# NPROC=(4 8 8 16 32)
NPROC=(36 36 72 72 108)
Visc="-novisc"
Resist="-noresist"
dt=(0.02 0.013333333333333332 0.01 0.008 0.006666666666666666)
...
do
    ...
    # OUTPUT
    JOBNAME=TGvortex_ORDER${ORDER[i]}_N${N[j]}
    OUTPUTDIR=output/TGvortex_ideal/order${ORDER[i]}/N${N[j]}
